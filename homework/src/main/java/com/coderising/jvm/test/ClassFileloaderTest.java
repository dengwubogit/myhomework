...
public class ClassFileloaderTest {
	...
	static String path1 = "D:\\code\\codeing2017\\myhomework\\homework\\target\\classes";
    ...
    public void testVersion(){    
		System.out.println(clzFile.getMinorVersion());
		System.out.println(clzFile.getMajorVersion());
